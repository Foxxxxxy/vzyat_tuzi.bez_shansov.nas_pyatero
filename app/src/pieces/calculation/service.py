...
def _handle_calculation(form: CalculationCreateRequestSchema, db: Session) -> CalculationPreparedDataSchema:
    ...
    calculation_prepared_data["total_employee_expenses"] = employee_amount * industry_model.avg_salary
    calculation_prepared_data["total_expenses"] += calculation_prepared_data["total_employee_expenses"]
    ...
    calculation_prepared_data["total_expenses"] += calculation_prepared_data["total_rent_expenses"]
    ...
    calculation_prepared_data["total_expenses"] += calculation_prepared_data["accounting_services_expenses"]
    ...
    calculation_prepared_data["total_expenses"] += calculation_prepared_data["total_equipments_expenses"]
    ...
    calculation_prepared_data["total_expenses"] += calculation_prepared_data["total_buildings_expenses"]
    ...
    calculation_prepared_data["total_expenses"] += calculation_prepared_data["total_additional_services_expenses"]
    ...
    calculation_prepared_data["total_expenses"] += calculation_prepared_data["total_additional_needs_expenses"]

    calculation_prepared_data["total_additional_expenses"] = \
        calculation_prepared_data["total_additional_services_expenses"] + \
        calculation_prepared_data["total_additional_needs_expenses"]
